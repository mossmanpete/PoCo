...
*/
			    ...
			    txMined = await aWorkerPoolInstance.contribute(woid,
						/*signed.hash*/'0x8839208909fb43bb4fe8a10b28685ede79a05789cd10c73e57d7ae602005d869',
						/*signed.sign*/ '0xbfcbe2e1c61f5ab13f7044565b82ceef25a842e2c7eca8e50bc5e8604623b360',
						/*sgxsign_v*/  '28',
						/*sgxsign_r*/'0x26fa003bff36455a9866031ecd9346c105d620e8afa60eb912904666d86b675f',
						/*sgxsign_s*/'0x77c4ceaa30d08a57b4b86403d32c025cde5a6f119bcba6412c15432eefc13d59', {
			      from: resourceProvider,
			      gas: constants.AMOUNT_GAS_PROVIDED
			    });
			    checkBalance = await aIexecHubInstance.checkBalance.call(resourceProvider);
...
*/
			    ...
			    txMined = await aWorkerPoolInstance.contribute(woid,
						/*signed.hash*/'0xd2b9b2bfd7321d007003572f1536fb98f63f7f209b0068faa5d85bfb5fd834d3',
						/*signed.sign*/ '0x51e503cbc1293c502347bb7f662c63abcdfa022304948d9ec0a120a3ecc7a30d',
						/*sgxsign_v*/  '28',
						/*sgxsign_r*/'0x26fa003bff36455a9866031ecd9346c105d620e8afa60eb912904666d86b675f',
						/*sgxsign_s*/'0x77c4ceaa30d08a57b4b86403d32c025cde5a6f119bcba6412c15432eefc13d59', {
			      from: resourceProvider,
